...
**Authors:** Dongyoung Kim, Sumin Park, Woomin Song, Seungku Kim, Taeyoung Kim et al. (9 authors)

**Published:** 2026-03-22 | **Categories:** cs.AI

**Links:** [arXiv](https://arxiv.org/abs/2603.21341v1) | [PDF](https://arxiv.org/pdf/2603.21341v1.pdf)

<details>
<summary>Abstract</summary>

Improving embodied reasoning in multimodal-large-language models (MLLMs) is essential for building vision-language-action models (VLAs) on top of them to readily translate multimodal understanding into low-level actions. Accordingly, recent work has explored enhancing embodied reasoning in MLLMs through supervision of vision-question-answering type. However, these approaches have been reported to result in unstable VLA performance, often yielding only marginal or even negative gains. In this pap...
